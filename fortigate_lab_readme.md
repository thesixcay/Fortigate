...
Se aplicó un perfil de **WAF** al servidor web Linux para proteger la
aplicación contra ataques comunes como:
...
Esto añade una capa adicional de protección para el servidor web.
